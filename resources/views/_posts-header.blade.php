<header class="max-w-xl mx-auto mt-20 text-center">
    ...
    <div class="space-y-2 lg:space-y-0 lg:space-x-4 mt-8">
        ...
        <div x-data="{ show: false }" @click.away="show=false">
            <button @click="show=!show" class="py-2 pl-3 pr-9 text-sm font-semibold" style="display: inline-flex">
                ...
                <div x-show="show" class="py-2 absolute bg-gray-100 w-full mt-2 rounded-xl z-50" style="display: none">
                   ...
                   All
                    ...
                    class="block text-left px-3 text-sm leading-6
                     ...
                     {{isset($currentCategory) && ($category->id ==$currentCategory->id) ? 'bg-blue-500 text-white':''}}">
